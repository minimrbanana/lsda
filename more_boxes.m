function more_boxes(rcnn_model, rcnn_feat, imname, outname)
th = tic;
% Read image
im = imread(imname);
...
index = 1;
thresh = 1; % percat threshold for nms
